      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            <Diamond className={`h-8 w-8 text-yellow-300 filter drop-shadow-lg ${!open && "mx-auto"}`} />
            {open && (
        ...
        >
          ...
          {open && (
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-600">admin@brilliantgems.com</span>
            </div>
          )}
        </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="bg-white p-3 rounded-lg shadow-sm flex items-center gap-3">
              ...
              <div className="text-sm">
                <div className="font-medium text-gray-900">New Notifications</div>
                <div className="text-xs text-gray-600">You have 5 unread messages</div>
              </div>
            </div>
          </div>
        )}
